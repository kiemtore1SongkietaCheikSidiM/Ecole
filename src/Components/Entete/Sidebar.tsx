  ...
  return (
    <aside
      className={`flex h-screen flex-col border-r border-slate-200/70 bg-white/85 shadow-lg shadow-slate-200 
         backdrop-blur-xl transition-all duration-300 ease-in-out dark:border-slate-700/70 
         dark:shadow-slate-950 dark:bg-slate-900/80 
         ${sidebarcollaps ? "w-65 md:w-56" : "w-19"}`}
    >
      <div
        className="flex items-center justify-between border-b border-slate-200/70 p-3 
      dark:border-slate-700/70 sm:p-4"
      >
