...
import type { Active, Bad, Best, Classes, Donne, genere, Moyennes, SidebarProps, stats, Student } from "../Types";
...
export const Eleve6eme: Student[] = [
    {
        Nom:"Sawadogo",
        Prenom:"Boris"
    },
...
export const Eleve5eme: Student[] = [
    {
        Nom:"Barry",
        Prenom:"Moussa"
    },
...
export const TimeLine = [
    {Temps:"7h-8h"},{Temps:"7h-9h"},{Temps:"8h-9h"},{Temps:"8h-10h"},{Temps:"9h-10h"},{Temps:"9h-11h"},{Temps:"10h-11h"},{Temps:"10h-12h"},{Temps:"11h-12h"},{Temps:"14h-16h"}
]